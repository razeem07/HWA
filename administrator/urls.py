...
urlpatterns = [
   ...
   path('bookings/<int:pk>/delete/', delete_booking, name='delete_booking'),
    ...
    path("newsletter/delete/<int:id>/", delete_subscriber, name="delete_subscriber"),
]
