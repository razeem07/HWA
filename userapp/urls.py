...
from .views import home,about,contact,specialization_detail,specialization_list,blog_list,blog_detail,doctor_list,doctor_detail,package_list,insurance_list,articles_detail,articles_list,contact_submit,service_detail,legal_page_detail,package_list_ajax,gallery_page
